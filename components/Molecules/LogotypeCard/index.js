...
export function LogotypeCard(props) {
  return (
    <>
      <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 pt-12 pb-4 bg-white mt-6  shadow-lg rounded-lg dark:bg-gray-800">
        <div class="flex-shrink-0">
          <div class="flex items-center mx-auto justify-center h-12 w-12 ">
